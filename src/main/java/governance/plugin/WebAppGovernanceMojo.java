...
public class WebAppGovernanceMojo extends AbstractMojo
{
    ...
    private String webAppEndPointRef = WebAppGovernanceMojo.GREG_URL + "Webapp.WebappHttpsSoap12Endpoint";
    ...
    {	
        ...
        getLog().info("SUMMARY:" 
                      ...
                      + "\nWebApplications....[Created:" + webApplicationCreator.getCreatedArtifactCount()
                      + ", Existing:" + webApplicationCreator.getExistingArtifactCount() + "]");
