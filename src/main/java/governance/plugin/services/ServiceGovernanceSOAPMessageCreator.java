...
public class ServiceGovernanceSOAPMessageCreator {
    public static String  createAddServiceRequest(String name, String version, String type, String description){
        ...
        soapRequest.append("xmlns:ser='http://services.add.xservices.governance.carbon.wso2.org'>");
        soapRequest.append("<soapenv:Header/>");
        soapRequest.append("<soapenv:Body>");
        soapRequest.append("<ser:addxService>");
